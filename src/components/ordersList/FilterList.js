...
const FilterList = ({ setCategoryArr,v1,v2, setValue1, setValue2, setSearchValue, filterFunc }) => {
    ...
    return (<div className="filter-orders">
        ...
        <DateButton setValue={setValue2} label={"עד תאריך"} value={v2}/>
            ...
            <div className="filter-container">
                <Button variant="contained" style={{ color: "white", backgroundColor: "orange", width: "15vw", fontSize: "large" }} onClick={filterFunc}>סנן</Button>
            </div>
    </div>)
}
