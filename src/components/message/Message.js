...
function Message() {
    ...
    return (<div className='messageDiv'>
        {type == 1 ?<Alert severity="info" style={{backgroundColor:"#f7f7f8",position:"relative", right:"33rem",  width:"50vw",  fontSize:"x-large"}}>
        ...
        {type == 0 && possible ?
            ...
            type == 0 && possible ?
                <Alert severity="info" style={{backgroundColor:"#f7f7f8",position:"relative", right:"3rem",  width:"50vw",  fontSize:"x-large"}}>
                    <AlertTitle>הפעולה לא הושלמה</AlertTitle>
