        ...
        >
            <Fade in={open}>
                <Box sx={style} style={{ textAlign: "center" }}>
                    <h3>דירוג האטרקציה:  </h3> <br />
                    <HoverRating value={value} setValue={setValue} /> <br />
                    <Box
                        component="form"
                        sx={{
                            '& .MuiTextField-root': { width: '25ch' },
                            '& .MuiInputBase-multiline': { padding: "1rem" },
                        }}
                        noValidate
                        autoComplete="off"
                    >
                    ...
                    {flag != 2 ? <Button
                        variant="contained"
                        size="large" onClick={submit}
                        style={{ backgroundColor: "orange" }}> הגש </Button>
                        :
                        <AlertMessage variant={'success'}
                            children={<Alerts message={"חוות הדעת שלך התווספה בהצלחה!"} />} />}
                </Box>
            </Fade>
        </Modal>
    </div>
